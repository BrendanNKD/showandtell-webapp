...
export const GenerateChoose2 = (): JSX.Element => {
  ...
  return (
    <div className="h-fit flex-col justify-center align-middle">
      ...
      <div className="bg-transparent flex flex-row justify-center w-full">
        <div className="overflow-hidden bg-[url(https://c.animaapp.com/NIGs1Y1e/img/group.png)] bg-[100%_100%] w-[1920px] h-[1136.7px] relative">
          ...
          <button
            className="absolute w-[911px] h-[181px] top-[259px] left-[486px]"
            onClick={() => {
              navigate({
                pathname: "/generate",
          ...
          <button
            className="absolute w-[911px] h-[181px] top-[466px] left-[486px]"
            onClick={() => {
              navigate({
                pathname: "/generate",
                search: createSearchParams({
          ...
          <button
            className="absolute w-[911px] h-[181px] top-[678px] left-[486px]"
            onClick={() => {
              navigate({
                pathname: "/generate",
                search: createSearchParams({
          ...
          <img
            ...
            alt="Frame"
            src="https://c.animaapp.com/NIGs1Y1e/img/frame-3.svg"
          />
          <button
            onClick={() => {
          ...
          >
            <img
              ...
              alt="Frame"
              src="https://c.animaapp.com/NIGs1Y1e/img/frame-4.svg"
            />
          </button>
          {/*
        <div className="absolute w-[1920px] h-[96px] -top-px left-px bg-white">
          <img
            ...
            alt="Frame"
            src="https://c.animaapp.com/NIGs1Y1e/img/frame-8.svg"
          />
          <img
            className="absolute w-[38px] h-[48px] top-[30px] left-[1701px]"
            alt="Group"
            src="https://c.animaapp.com/NIGs1Y1e/img/group-1@2x.png"
          />
          ...
          <img
            ...
            alt="Frame"
            src="https://c.animaapp.com/NIGs1Y1e/img/frame-9.svg"
          />
  </div>*/}
        </div>
      </div>
