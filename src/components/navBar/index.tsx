      ...
      <nav>
        <div className="w-full h-[9%] z-10 fixed">
          <div className="flex flex-row justify-center md:justify-evenly items-center relative w-full h-[100%] top-0 left-0 bg-white drop-shadow-md space-x-2 md:space-x-1 p-4">
            ...
            <div
              className="hidden w-full md:block md:w-auto bg-white"
              id="navbar-default"
            >
              <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-white md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-">
                <li>
                  <div
